    ...
    <div className="min-h-screen bg-white">
        ...
        <section className={`${TOKENS.SECTION_PADDING} pt-32`}>
          <div className={TOKENS.CONTAINER_CLASS}>
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                <h1 className={`${TOKENS.H1_CLASS} text-foreground mb-6`}>For Teachers</h1>
                <p className={`${TOKENS.BODY_CLASS} text-foreground mb-8`}>
                  Professional development and comprehensive training that empowers educators to
                  confidently teach coding and computational thinking – no prior experience
                  required.
                </p>
      ...
      <AltSection index={sectionIndex++}>
        <ImageContentSection
          ...
          body={
            <div>
              <p className="mb-4">
                Our programs are designed by experienced educators who understand the challenges
                teachers face. We provide everything you need to succeed, regardless of your
                technical background.
              </p>
              <p>
                From your first lesson to advanced concepts, our support system ensures you feel
                confident and prepared every step of the way.
              </p>
            </div>
          }
          align="left"
        ...
        <section className={TOKENS.SECTION_PADDING}>
          <div className={TOKENS.CONTAINER_CLASS}>
            <div className="text-center mb-12">
              <h2 className={`${TOKENS.H2_CLASS} text-white mb-4`}>What Teachers Gain</h2>
              <p className={`${TOKENS.BODY_CLASS} text-white opacity-90 max-w-2xl mx-auto`}>
                Professional development that enhances your teaching practice and opens new
              ...
              {[
                {
                  ...
                  description:
                    "Start teaching coding and computational thinking from day one with our beginner-friendly approach and comprehensive support.",
                },
                {
                  icon: BookOpen,
                  title: "Ready-to-Use Resources",
                  description:
                    "Complete lesson plans, student worksheets, assessment tools, and presentation materials – everything prepared for you.",
                },
                {
                  icon: HeartHandshake,
                  title: "Ongoing Professional Support",
                  description:
                    "Access to expert mentors, peer community, and continuous learning opportunities to grow your expertise.",
                },
              ].map((benefit, index) => {
      ...
      <AltSection index={sectionIndex++}>
        <ImageContentSection
          ...
          body={
            <div>
              <p className="mb-4">
                Our comprehensive training package includes detailed lesson plans, video tutorials,
                hands-on workshops, and ongoing mentorship to ensure your success.
              </p>
              <p>
                From classroom management tips to technical guidance, we provide practical support
                that makes teaching coding enjoyable and effective.
              </p>
            </div>
          }
                ...
                {[
                  {
                    ...
                    description:
                      "Start with basics and progressively build expertise through hands-on practice and guided learning experiences.",
                  },
                  {
                    title: "Practical Application",
                    description:
                      "Learn by doing – practice teaching methods with real lessons and receive feedback from experienced mentors.",
                  },
                  {
                    title: "Collaborative Learning",
                    description:
                      "Connect with fellow educators, share experiences, and learn from a supportive community of teachers.",
                  },
                ].map((approach, index) => (
                  <motion.div
                    key={index}
          ...
          <div className={TOKENS.CONTAINER_CLASS}>
            <div className="text-center max-w-4xl mx-auto mb-12">
              ...
              <p className={`${TOKENS.BODY_CLASS} text-white opacity-90`}>
                A structured pathway from introduction to expertise, with support and guidance every
                step of the way.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  description:
                    "Learn basic concepts and pedagogical approaches through interactive workshops and hands-on practice sessions.",
                },
                {
                  step: "02",
                  title: "Classroom Implementation",
                  description:
                    "Begin teaching with full support, mentorship, and ready-made lesson plans tailored to your schedule.",
                },
                {
                  step: "03",
                  title: "Expert Development",
                  description:
                    "Advance your skills, earn certification, and become a leader in future-skills education at your school.",
                },
              ].map((step, index) => (
                <motion.div
                  key={index}
      ...
      <AltSection index={sectionIndex++}>
        <ImageContentSection
          ...
          body={
            <div>
              <p className="mb-4">
                Connect with teachers worldwide who are transforming education through technology.
                Share experiences, learn from each other, and grow together.
              </p>
              <p>
                Our community provides ongoing support, inspiration, and professional development
                opportunities that extend far beyond initial training.
              </p>
            </div>
          }
          align="left"
      ...
      <AltSection index={sectionIndex++}>
        <section className={TOKENS.SECTION_PADDING}>
          <div className={TOKENS.CONTAINER_CLASS}>
            <div className="text-center max-w-4xl mx-auto">
              <h2 className={`${TOKENS.H2_CLASS} text-white mb-8`}>Teacher Outcomes & Results</h2>
              <div className="grid md:grid-cols-3 gap-8">
                {[
                  {
                    title: "Teaching Confidence",
                    description:
                      "Gain the skills and confidence to lead engaging coding lessons that inspire and educate students effectively.",
                    icon: GraduationCap,
                  },
                  {
                    title: "Professional Growth",
                    description:
                      "Expand your skill set, earn valuable certifications, and enhance your career prospects in education.",
                    icon: Award,
                  },
                  {
                    title: "Student Impact",
                    description:
                      "See your students develop critical thinking, creativity, and problem-solving skills that benefit all subjects.",
                    icon: Lightbulb,
                  },
                ].map((outcome, index) => {
