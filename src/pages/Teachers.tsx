...
import { GraduationCap, BarChart3, Calendar, FileText, Play, CheckCircle, Target, Zap } from 'lucide-react';
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
            ...
            <div className="flex items-center gap-8 lg:gap-20 max-lg:flex-col">
              ...
              >
                <div className="space-y-6">
                  ...
                  <p className="text-lg sm:text-xl text-white leading-relaxed">
                    Comprehensive tools and resources to enhance your teaching experience and student outcomes
                  </p>
              ...
              >
                <div className="relative aspect-video bg-gradient-to-br from-primary/20 to-accent/20 rounded-2xl lg:rounded-[32px] overflow-hidden group cursor-pointer"
                     onClick={() => openVideoModal('https://example.com/videos/teacher-hero.mp4', 'Teacher Resources Overview')}>
        ...
        <section className="bg-[#03182F] py-16 px-4 sm:px-8 lg:px-16">
          <div className="container max-w-screen-xl mx-auto">
            <h2 className="text-3xl font-medium text-white text-center mb-12">Empower Your Teaching</h2>
        ...
        <section className="bg-[#021223] py-16 px-4 sm:px-8 lg:px-16">
          <div className="container max-w-screen-xl mx-auto">
            <h2 className="text-3xl font-medium text-white text-center mb-12">Teacher Success Stories</h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <VideoThumbnail
                videoUrl="https://example.com/videos/teacher-overview.mp4"
                title="Teacher Platform Overview"
                duration="2:40"
                onPlay={() => openVideoModal('https://example.com/videos/teacher-overview.mp4', 'Teacher Platform Overview')}
              />
              <VideoThumbnail
                videoUrl="https://example.com/videos/curriculum-tools.mp4"
                title="Curriculum Management Tools"
                duration="3:25"
                onPlay={() => openVideoModal('https://example.com/videos/curriculum-tools.mp4', 'Curriculum Management Tools')}
              />
              <VideoThumbnail
                videoUrl="https://example.com/videos/student-analytics.mp4"
                title="Student Analytics Dashboard"
                duration="2:55"
                onPlay={() => openVideoModal('https://example.com/videos/student-analytics.mp4', 'Student Analytics Dashboard')}
              />
              <VideoThumbnail
                videoUrl="https://example.com/videos/assessment-tools.mp4"
                title="Assessment & Grading Tools"
                duration="2:30"
                onPlay={() => openVideoModal('https://example.com/videos/assessment-tools.mp4', 'Assessment & Grading Tools')}
              />
              <VideoThumbnail
                videoUrl="https://example.com/videos/teacher-testimonials.mp4"
                title="Teacher Success Stories"
                duration="3:15"
                onPlay={() => openVideoModal('https://example.com/videos/teacher-testimonials.mp4', 'Teacher Success Stories')}
              />
            </div>
          </div>
        </section>
        ...
        <section className="bg-[#03182F] py-16 px-4 sm:px-8 lg:px-16">
          <div className="container max-w-screen-xl mx-auto text-center">
            <h2 className="text-3xl font-medium text-white mb-8">Transform Your Teaching Experience</h2>
            ...
            <p className="text-white/60 mt-4">Powerful tools. Better outcomes. Enhanced teaching experience.</p>
          </div>
        </section>
      </main>
      <Footer />
