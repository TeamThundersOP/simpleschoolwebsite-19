...
import { Check, ArrowRight, Star, Users, GraduationCap, School, Play, ChevronRight, Phone, Mail } from 'lucide-react';
          ...
          <div className="box-border flex max-w-screen-xl flex-col items-center gap-8 w-full m-0 p-0">
            ...
            <div className="flex flex-wrap justify-center gap-8 opacity-60">
              {['School A', 'School B', 'School C', 'School D'].map((school, index) => (
                <div key={index} className="text-sm font-medium text-gray-600">{school}</div>
              ))}
            </div>
          </div>
        </section>
