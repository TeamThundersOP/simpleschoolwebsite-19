      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 auto-rows-[280px]">
        {mediaItems.map((item, index) => {
          ...
          const getLayoutClass = (index: number) => {
            switch (index) {
              case 0: return 'md:col-span-2 md:row-span-2'; // Large feature item
              case 1: return 'md:col-span-1 md:row-span-1'; // Standard item
              case 2: return 'md:col-span-1 md:row-span-1'; // Standard item  
              case 3: return 'md:col-span-1 md:row-span-1'; // Standard item
              case 4: return 'md:col-span-1 md:row-span-1'; // Standard item
