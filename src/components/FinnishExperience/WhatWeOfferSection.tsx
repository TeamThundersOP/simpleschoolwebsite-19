  ...
  const offerings = [
    {
      ...
      description:
        "Award-winning Finnish apps and EdTech solutions for early years, primary, secondary, and tertiary education, all members of Education Finland and globally recognised.",
    },
    {
      icon: <GraduationCap className="w-8 h-8 text-highlight" />,
      title: "Training",
      description:
        "Hands-on teacher and leadership training with real classroom demonstrations. Focused on solving practical challenges and improving daily teaching.",
      examples: [
    ...
    },
    {
      ...
      title: "Events",
      description:
        "Expert-led workshops and conferences connecting Indian educators with Finnish specialists.",
      examples: [
    ...
    },
    {
      ...
      description:
        "Custom-made education tours and camps in Finland, with school visits, teacher shadowing, and leadership workshops.",
      examples: [
                  ...
                  <div className="space-y-2">
                    ...
                    <ul className="space-y-1">
                      {offering.examples.map((example, exampleIndex) => (
                        <li
                          key={exampleIndex}
                          className="flex items-start gap-2 text-highlight opacity-80 text-sm"
                        >
