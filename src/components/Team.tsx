        ...
        <div className="box-border flex items-center gap-8 lg:gap-20 w-full m-0 p-0 max-lg:flex-col max-lg:gap-8">
          ...
          >
            {teamMembers.map((member, index) => (
              ...
              >
                <div className="box-border relative overflow-hidden rounded-2xl w-48 sm:w-56 lg:w-64 aspect-square mx-auto lg:mx-0">
                  <img
                    src={member.image}
                    alt={`${member.name} - ${member.role}`}
                    className="box-border w-full h-full object-cover object-center m-0 p-0"
                  />
                </div>
