...
const Team = () => {
  ...
  return (
    <section id="about" className="box-border flex w-full flex-col items-center gap-12 lg:gap-20 bg-[#021223] m-0 px-4 sm:px-8 lg:px-16 py-16 sm:py-20 lg:py-28">
      <div className="box-border flex max-w-screen-xl flex-col items-start gap-12 lg:gap-20 w-full m-0 p-0">
        ...
        <div className="box-border flex flex-col items-start gap-8 lg:gap-16 w-full m-0 p-0">
          <div className="box-border w-full overflow-x-auto lg:overflow-visible m-0 p-0">
            <motion.div 
              className="box-border flex items-start gap-6 lg:gap-8 min-w-max lg:grid lg:grid-cols-3 lg:min-w-0 m-0 p-0"
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true }}
              variants={{
            ...
            >
              {teamMembers.map((member, index) => (
                <motion.article 
                  key={index} 
                  className="box-border flex flex-col items-start gap-4 lg:gap-6 w-72 lg:w-full flex-shrink-0 m-0 p-0"
                  variants={{
