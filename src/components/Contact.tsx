  ...
  const contactInfo = [
    ...
    },
    {
      icon: (
        ...
        >
          <path
            d="M12.2988 4.33496C7.33028 4.33496 3.29883 8.36641 3.29883 13.335C3.29883 18.3036 7.33028 22.335 12.2988 22.335C17.2576 22.335 21.2988 18.3036 21.2988 13.335C21.2988 8.36641 17.2576 4.33496 12.2988 4.33496ZM12.2988 6.33496C16.1769 6.33496 19.2988 9.45684 19.2988 13.335C19.2988 17.2132 16.1769 20.335 12.2988 20.335C8.42066 20.335 5.29883 17.2132 5.29883 13.335C5.29883 9.45684 8.42066 6.33496 12.2988 6.33496ZM12.2988 10.335C10.6419 10.335 9.29883 11.6779 9.29883 13.335C9.29883 14.9921 10.6419 16.335 12.2988 16.335C13.9557 16.335 15.2988 14.9921 15.2988 13.335C15.2988 11.6779 13.9557 10.335 12.2988 10.335Z"
            fill="#0C0504"
          ></path>
          <path
            d="M12.2988 24.335C8.29883 24.335 1.29883 26.335 1.29883 30.335V32.335C1.29883 33.4396 2.19426 34.335 3.29883 34.335H21.2988C22.4034 34.335 23.2988 33.4396 23.2988 32.335V30.335C23.2988 26.335 16.2988 24.335 12.2988 24.335Z"
            fill="#0C0504"
          ></path>
        </svg>
      ),
    ...
    },
    {
      icon: (
        ...
        >
          <path
            d="M12.2988 2.33496C6.77598 2.33496 2.29883 6.81211 2.29883 12.335C2.29883 19.335 12.2988 31.335 12.2988 31.335C12.2988 31.335 22.2988 19.335 22.2988 12.335C22.2988 6.81211 17.8217 2.33496 12.2988 2.33496ZM12.2988 16.335C10.0897 16.335 8.29883 14.5441 8.29883 12.335C8.29883 10.1259 10.0897 8.33496 12.2988 8.33496C14.508 8.33496 16.2988 10.1259 16.2988 12.335C16.2988 14.5441 14.508 16.335 12.2988 16.335Z"
            fill="#0C0504"
          ></path>
        </svg>
      ),
      ...
      <div className="box-border flex max-w-screen-xl flex-col items-center w-full m-0 p-0">
        <div className="box-border flex flex-col items-center w-full gap-4 m-0 p-0">
          ...
          <p className="box-border w-full text-center text-[#0C0504] text-sm sm:text-base md:text-lg font-normal leading-relaxed m-0 p-0 max-w-2xl">
            We’re here to help! Reach out to us for partnership opportunities, product demos, or any
