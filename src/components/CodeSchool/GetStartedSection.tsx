    ...
    <section className="py-20 bg-[rgb(17,24,39)] text-white">
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Button size="lg" variant="secondary" className="w-full sm:w-auto bg-white text-[rgb(17,24,39)] hover:bg-gray-100">
            → Book a 20-minute consultation
          </Button>
          <Button size="lg" variant="outline" className="w-full sm:w-auto border-white text-white hover:bg-white hover:text-[rgb(17,24,39)]">
