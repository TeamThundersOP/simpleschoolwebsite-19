    ...
    <section className="py-16 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <h2 className="text-3xl font-bold mb-8 text-highlight">Pedagogy & Fit for India</h2>
          ...
          <div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                <div className="w-5 h-5 bg-highlight/10 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5 mr-3">
                  <Calendar className="w-3 h-3 text-highlight" />
                </div>
                <span>Timetable integration across subjects and grades</span>
              </div>
              <div className="flex items-start">
                <div className="w-5 h-5 bg-highlight/10 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5 mr-3">
                  <Trophy className="w-3 h-3 text-highlight" />
                </div>
