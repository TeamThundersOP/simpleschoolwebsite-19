        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-6">
            ...
            <Card className="rounded-xl border border-[rgba(0,0,0,0.12)]">
              <CardHeader>
                <CardTitle className="text-xl text-highlight">
                  Early Years (K–2 | Ages 5–7) – Future Thinker
                </CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-sm text-highlight/80">
                  Help young children develop computational thinking through playful activities that
                  spark curiosity and prepare them for digital learning.
                </CardDescription>
              </CardContent>
            </Card>
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="text-sm text-highlight/80">
                      Discover AI through engaging, unplugged activities and creative exploration
                    </p>
                  </div>
                  <div>
                    <h4 className="font-semibold mb-1">Junior Coder</h4>
                    <p className="text-sm text-highlight/80">
                      Develop computational thinking and problem-solving through hands-on ScratchJr
                      activities
                    </p>
                  </div>
                </div>
            ...
            <Card className="rounded-xl border border-[rgba(0,0,0,0.12)]">
              <CardHeader>
                <CardTitle className="text-xl text-highlight">
                  Upper Primary (Grades 3–6 | Ages 8–11)
                </CardTitle>
              </CardHeader>
              <CardContent>
                <div>
                  ...
                  <p className="text-sm text-highlight/80">
                    Practise computational thinking by creating stories, games, and AI apps using
                    Scratch
                  </p>
                </div>
              </CardContent>
            ...
            <Card className="rounded-xl border border-[rgba(0,0,0,0.12)]">
              <CardHeader>
                <CardTitle className="text-xl text-highlight">
                  Middle School (Grades 3–8 | Ages 8–13)
                </CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="text-sm text-highlight/80">
                      Practical experience in automation and embedded systems using sensors,
                  ...
                  <div>
                    ...
                    <p className="text-sm text-highlight/80">
                      Design and build educational games by applying product development principles
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="rounded-xl border border-[rgba(0,0,0,0.12)]">
              <CardHeader>
                <CardTitle className="text-xl text-highlight">
                  Lower Secondary (Grades 6–9 | Ages 11–15)
                </CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="text-sm text-highlight/80">
                      Build work-life skills through innovative, project-based textual programming
                    </p>
                  </div>
                  <div>
                    <h4 className="font-semibold mb-1">AI Vision</h4>
                    <p className="text-sm text-highlight/80">
                      Create machine vision and augmented reality projects to explore AI creatively
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="rounded-xl border border-[rgba(0,0,0,0.12)]">
              <CardHeader>
                <CardTitle className="text-xl text-highlight">
                  Upper Secondary (Grades 8–12 | Ages 13–17)
                </CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="text-sm text-highlight/80">
                      Learn to navigate the internet and computer systems safely and independently
                    </p>
                  </div>
                  <div>
                    <h4 className="font-semibold mb-1">Web Innovator</h4>
                    <p className="text-sm text-highlight/80">
                      Progress from basic web design to AI-enhanced applications
                    </p>
                  </div>
                  <div>
                    <h4 className="font-semibold mb-1">Teachable Machine</h4>
                    <p className="text-sm text-highlight/80">
                      Investigate AI classifiers and social media profiling through experimental
                      projects
                    </p>
                  </div>
                </div>
            ...
            <Card className="rounded-xl border border-[rgba(0,0,0,0.12)]">
              <CardHeader>
                <CardTitle className="text-xl text-highlight">
                  Senior Secondary (Grades 9–12 | Ages 14–18)
                </CardTitle>
              </CardHeader>
              <CardContent>
                <div>
                  ...
                  <p className="text-sm text-highlight/80">
                    Conduct experiments with electromechanics and embedded systems to build
                    sensor-activated games
                  </p>
                </div>
              </CardContent>
            </Card>
